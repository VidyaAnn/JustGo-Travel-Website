    ...
    <footer aria-label="Site Footer" class="bg-white">
      <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="lg:flex lg:items-start lg:gap-8">
          <div class="text-600">
            <SiYourtraveldottv className="icon"></SiYourtraveldottv>
          </div>

          <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:w-full lg:gap-y-16">
            ...
            <div class="col-span-2 sm:col-span-1">
              <p class="font-medium text-gray-900">OUR AGENCY</p>
            ...
            <div class="col-span-2 sm:col-span-1">
              <p class="font-medium text-gray-900">PARTNERS</p>
            ...
            <div class="col-span-2 sm:col-span-1">
              <p class="font-medium text-gray-900">LAST MINUTE</p>
